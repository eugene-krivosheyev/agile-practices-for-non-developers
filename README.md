...
### Культура и процесс
- *Производственная культура* и осознание личной и командной культур инженерами
...
- *Кросс-функциональность* команды для надежного производства в условиях разнообразных задач
...
- Культура DevOps и практика Continouos Feedback
