...
- [ ] Договоренности
- [ ] Выбор PO и разбивка по командам по "бразильской системе" в соотвествии с принципами Scrum
...
## Что продуктовый бизнес ждет от _производственной культуры_ (1.5/1)
