...
# Objectives
## После тренинга участники смогут применять в команде инженеров:
...
1. Договоренности
1. Выбор PO и разбивка по командам по "бразильской системе" в соотвествии с принципами Scrum
1. Самостоятельный обзор тренинга и парковка проблем участников от команд
...
1. Ключевые метрики продуктового бизнеса
1. Что инженеры обычно не принимают от бизнес-модели
...
1. Метафора для разработки: туповатые миньончики и инструкции для них
1. Исходники и компиляция
1. Библиотеки
1. Автотесты
1. Запуск приложения
1. Процедурный стиль vs объектный
1. Строгая и нестрогая типизация
### Практика «разработки» в выбранной метафоре
1. Моделирование на Java процессов сохранения и чтения в организации миньонов
1. Рефакторинг этой domain model в объектном стиле
...
## Введение в архитектуру современных систем (2/1)
